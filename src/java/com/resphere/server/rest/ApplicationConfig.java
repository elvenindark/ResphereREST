...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(com.resphere.server.rest.AccesovFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.EquipovFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.EventovFacadeREST.class);
        resources.add(com.resphere.server.rest.ImpactoFacadeREST.class);
        resources.add(com.resphere.server.rest.ImpactovFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.MediovidavFacadeREST.class);
        resources.add(com.resphere.server.rest.MonitoreorespuestaFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.NurgentevFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.PoblacionvFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.SaludvFacadeREST.class);
        ...
        resources.add(com.resphere.server.rest.ServiciovFacadeREST.class);
